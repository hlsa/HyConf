...
STEP_RETURN LinearSpeedSM::smallstep()
{
    switch (state)
    {
        ...
        case SEND_OUTPUT:
            ...
            // Changed this to use horizontal acceleration instead of vertical.
            // The vertical acceleration was used to deal with the fact that the robot
            // moved up and down an inclined plain.
            linear_speed = get_linear_speed(spl.X,spr.X);
            return CONTINUE;
        break;
