...
void VacuumCleanerBehaviour::step()
{
    ...
    printf("o1_event: %s\n", inputduplicationsm1->o1_event?"true":"false");
    printf("o2_event: %s\n", inputduplicationsm1->o2_event?"true":"false");
    printf("\n");

    printf("inputduplicationsm2\n");
    inputduplicationsm2->step();
    printf("o1_event: %s\n", inputduplicationsm2->o1_event?"true":"false");
    printf("o2_event: %s\n", inputduplicationsm2->o2_event?"true":"false");
    printf("\n");   
    ...
    angularspeedsm->step();
    printf("acc_l_event: %s\n", angularspeedsm->angle_event?"true":"false");
    printf("acc_r_event: %s\n", angularspeedsm->angle_event?"true":"false");
    printf("\n");
    
    printf("speedsm1\n");
    speedsm1->step();
    printf("sp_event: %s\n", speedsm1->sp_event?"true":"false");
    printf("acc_ack_event: %s\n", speedsm1->acc_ack_event?"true":"false");
    printf("\n");

    printf("linearspeedsm\n");
    linearspeedsm->step();
    printf("linear_speed_event: %s\n", linearspeedsm->linear_speed_event?"true":"false");
    printf("\n");

    printf("speedsm2\n");
    speedsm2->step();
    printf("sp_event: %s\n", speedsm2->sp_event?"true":"false");
    printf("acc_ack_event: %s\n", speedsm2->acc_ack_event?"true":"false");
    printf("\n");

    printf("pid1\n");
    pid1->step();
    printf("err_output_event: %s\n", pid1->err_output_event?"true":"false");
    printf("\n");

    printf("inputduplicationsm3\n");
    inputduplicationsm3->step();
    printf("o1_event: %s\n", inputduplicationsm3->o1_event?"true":"false");
    printf("o2_event: %s\n", inputduplicationsm3->o2_event?"true":"false");
    printf("\n");

    printf("pathplanningsm\n");
    pathplanningsm->step();
    printf("clean_event: %s\n", pathplanningsm->clean_event?"true":"false");
    printf("move_forward_event: %s\n", pathplanningsm->move_forward_event?"true":"false");
    printf("stop_event: %s\n", pathplanningsm->stop_event?"true":"false");
    printf("turn_event: %s\n", pathplanningsm->turn_event?"true":"false");
    printf("\n");

    printf("displacementsm\n");
    displacementsm->step();
    printf("displacement_out_event: %s\n", displacementsm->displacement_out_event?"true":"false");
    printf("\n");
    printf("turn_event: %s\n", pathplanningsm->turn_event?"true":"false");

    printf("pid2\n");
    pid2->step();
    printf("err_output_event: %s\n", pid2->err_output_event?"true":"false");
    printf("\n");
    printf("------------------------------\n");
